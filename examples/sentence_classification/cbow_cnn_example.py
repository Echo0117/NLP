...
@author: Echo
"""
from data_processing.data_loader import loadTexts
...
if __name__ == '__main__':
    ...
    """data processing"""
    postxt = loadTexts(project_path + config["dataset"]["imdbPath"]["posSentencesPath"], limit=LIM)
    negtxt = loadTexts(project_path + config["dataset"]["imdbPath"]["negSentencesPath"], limit=LIM)
    ...
    """training"""
    _, _, model = Trainer(n_epoch, batch_size, lr).trainer(model, train_set, train_label, test_set, test_label, loss_function, optimizer)
